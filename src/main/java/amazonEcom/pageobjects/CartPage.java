...
public class CartPage extends AbstractComponent {
	...
	WebElement btnChromeCart;
	
	@FindBy(css= "span#sw-gtc span.a-button-inner a.a-button-text")
	WebElement btnFFCart;
	...
	public void btnCartChromeClick() {
		btnChromeCart.click();
	}

	public void btnCartFirefoxClick() {
		btnFFCart.click();
	}
